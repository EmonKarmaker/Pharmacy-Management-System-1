                ...
                <div class="table-responsive">
                    ...
                    <thead class="text-white" style="background-color:orange;">
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                <a class="btn mr-1" style="background-color:orange; color:white;" href="{{ route('sale-info-edit', ['slug' => $data->sale_info_slug]) }}" title="Edit">Edit</a>
                                <a class="btn mr-1" style="background-color:orange; color:white;" href="{{ route('sale-info-view', ['slug' => $data->sale_info_slug]) }}" title="Download Invoice as PDF">View Invoice</a>
