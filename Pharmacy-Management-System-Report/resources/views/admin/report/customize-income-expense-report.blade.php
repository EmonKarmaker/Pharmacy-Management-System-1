              ...
              <div class="row summary_date_form_section">
                <div class="col-md-3">
                  <div class="form-group row">
                    <label for="" class="col-md-4 col-form-label text-white" style="background-color:orange; color:white;"><i class=""><span class="search_text"> From</span></i></label>
                    <div class="col-md-8">
                ...
                <div class="col-md-3">
                  <div class="form-group row">
                    <label for="" class="col-md-4 col-form-label text-white" style="background-color:orange; color:white;"><i class=""><span class="search_text"> To</span></i></label>
                    <div class="col-md-8">
                ...
                <div class="col-md-3">
                  <input type="button" class="btn" style="background-color:orange; color:white;" id="search" value="SEARCH">
                </div>
