...
<html>
	...
	<body>
		<button id="download-button" class="btn" style="background-color:red; color:white;">Download Invoice as PDF</button>
...
<script>
    ...
    function generatePDF() {
        ...
        const options = {
            margin: [10, 10], // Margin in millimeters
            filename: 'invoice.pdf',
            image: { type: 'jpeg', quality: 0.98 },
            html2canvas: { scale: 2 }, // Higher scale improves quality
            jsPDF: { unit: 'mm', format: 'a5', orientation: 'portrait' } // A5 paper size
        };
